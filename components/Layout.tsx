...
export const Layout: React.FC<LayoutProps> = ({ 
  ...
  return (
    <div className="min-h-screen flex flex-col font-urbanist relative selection:colors.primary selection:text-white">
      ...
      <header className="fixed top-0 left-0 right-0 h-24 z-50 px-8 flex items-center justify-between pointer-events-none">
         ...
         */}
         <div className="pointer-events-auto bg-white rounded-full shadow-float px-6 py-3 flex items-center gap-4 transition-transform hover:scale-[1.02]">
             {/* SMART DATA-FLOW: Logo reads from settings store */}
             <ThemedLogo size={32} />
             <div className="flex flex-col">
                <span className="font-bold text-sm tracking-wide text-brand-black"><ThemedPlatformName /></span>

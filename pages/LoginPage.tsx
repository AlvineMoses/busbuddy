...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
 ...
 {/* Social Sign-in: only visible when feature flag is ON and permission is enabled for at least one role */}
 {featureFlags.socialSignIn && settings.permissionGroups.some((g: any) => g.permissions.some((p: any) => p.id === 'mod_4' && (p.admin || p.schoolAdmin))) && (

...
export const LoginPage: React.FC<LoginPageProps> = ({ onLogin }) => {
 ...
 const { colors, platformName, loginHeroImage, testimonials } = useTheme();
 ...
 style={{
 borderColor: recoveryMethod === 'EMAIL' ? colors.primary : '#e5e7eb',
 color: recoveryMethod === 'EMAIL' ? colors.primary : '#6b7280'
 }}
 >
 <Mail size={24} />
 ...
 className="p-4 rounded-2xl border flex flex-col items-center justify-center gap-2 transition-all"
 style={{
 borderColor: recoveryMethod === 'SMS' ? colors.primary : '#e5e7eb',
 color: recoveryMethod === 'SMS' ? colors.primary : '#6b7280'
 }}
 >
 ...
 className="p-4 rounded-2xl border flex flex-col items-center justify-center gap-2 transition-all"
 style={{
 borderColor: recoveryMethod === 'WHATSAPP' ? colors.primary : '#e5e7eb',
 color: recoveryMethod === 'WHATSAPP' ? colors.primary : '#6b7280'
 }}
 >
 <Smartphone size={24} />
 ...
 className="p-4 rounded-2xl border flex flex-col items-center justify-center gap-2 transition-all"
 style={{
 borderColor: recoveryMethod === 'IN_APP' ? colors.primary : '#e5e7eb',
 color: recoveryMethod === 'IN_APP' ? colors.primary : '#6b7280'
 }}
 >
 <Bell size={24} />
 ...
 className="w-14 h-14 text-center text-2xl font-bold border border-gray-200 rounded-2xl outline-none transition-all bg-white"
 ...
 <img src={testimonials?.[0]?.avatar || "https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=2574&auto=format&fit=crop"} className="w-14 h-14 rounded-full object-cover border-2 border-white/20" alt={testimonials?.[0]?.name || "Testimonial"} />
 <div>
 <h4 className="text-xl font-bold text-white">{testimonials?.[0]?.name || "Riaot Escanor"}</h4>
 <p className="text-gray-400 text-sm">{testimonials?.[0]?.role || "Project Manager at Google"}</p>
 </div>
 </div>
 <p className="text-gray-200 text-lg font-light leading-relaxed mb-8">
 "{testimonials?.[0]?.text || "I Landed Multiple Projects Within A Couple Of Days - With This Tool. Definitely My Go To Freelance Platform Now!"}"
 </p>

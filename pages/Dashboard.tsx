...
export const Dashboard: React.FC<DashboardProps> = ({ routes, user, onNavigate }) => {
 ...
 <button onClick={() => setFeedTab('fleet')} className={`flex-1 py-3 text-xs font-bold uppercase tracking-wider rounded-xl transition-all ${feedTab === 'fleet' ? 'shadow-sm text-white' : 'text-gray-400 hover:text-gray-600'}`}>Fleet Status</button>

      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 px-2">
        ...
        {unreadCount > 0 && (
          <button 
            ...
            className="px-6 py-3 rounded-2xl border-2 border-gray-200 hover:border-[#ff3600] text-gray-600 hover:text-[#ff3600] font-bold transition-all flex items-center gap-2"
          >
            <Check size={18} />
            Mark All as Read
          </button>
        ...
        <div className="flex flex-wrap gap-3">
          <button
            ...
            className={`px-5 py-2.5 rounded-full font-bold text-sm transition-all ${
              filter === 'ALL'
                ? 'bg-[#ff3600] text-white shadow-lg'
        ...
        {filteredNotifications.map((notification) => (
          <div
            ...
            className={`bg-white rounded-[2rem] p-6 shadow-soft-xl border transition-all ${
              notification.read ? 'border-gray-100' : 'border-[#ff3600]/20 shadow-xl'
            ...
            <div className="flex items-start gap-4">
                ...
                <div className="flex items-center gap-3">
                  {!notification.read && (
                    <button
                      ...
                      className="text-xs font-bold text-[#ff3600] hover:underline"
                    >
                      Mark as Read
                    </button>
                  )}
              ...
              {!notification.read && (
                <div className="flex-shrink-0">
                  <div className="w-2.5 h-2.5 rounded-full bg-[#ff3600] shadow-[0_0_8px_#ff3600]"></div>
                </div>
              )}
            </div>
          </div>

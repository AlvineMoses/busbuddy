        ...
        {activeTab === 'routes' && (
            <div className="flex items-center gap-3">
              ...
              <button 
                ...
                className="bg-[#ff3600] text-white px-8 py-3.5 rounded-full text-sm font-bold shadow-xl shadow-[#ff3600]/20 transition-all flex items-center gap-2"
              >
                ...
                {filteredRoutes.map((route) => (
                    <div key={route.id} className="bg-white rounded-[2.5rem] p-6 shadow-soft-xl border border-gray-100 hover:shadow-2xl transition-all group relative cursor-pointer flex flex-col h-full">
                        ...
                        <div className="mt-auto flex gap-2">
                            <span className={`flex-1 text-center py-2 rounded-full text-[10px] font-bold tracking-wide border ${
                                route.type === 'PICKUP' 
                                ? 'bg-[#bda8ff]/10 text-[#bda8ff] border-[#bda8ff]/20' 
                            ...
                            <div className={`flex items-center gap-2 px-3 py-2 rounded-full border ${route.status === 'INACTIVE' ? 'bg-gray-100 border-gray-200' : 'bg-white border-gray-100'}`}>
                                {route.status === 'INACTIVE' ? (
                                    ...
                                    <>
                                        ...
                                        route.health === RouteHealth.NORMAL ? 'bg-[#1fd701] shadow-[0_0_8px_#1fd701]' :
                                        route.health === RouteHealth.DELAYED ? 'bg-[#ff9d00] shadow-[0_0_8px_#ff9d00]' : 'bg-[#FF6106] shadow-[0_0_8px_#FF6106]'
                                        }`}></div>
                     ...
                     {[1,2,3,4,5,6].map((num) => (
                       <div key={num} className="flex items-center p-5 rounded-[1.8rem] bg-white border border-gray-100 hover:border-brand-lilac/30 hover:shadow-lg hover:shadow-brand-lilac/5 transition-all group">
                         ...
                         <div className="opacity-0 group-hover:opacity-100 transition-opacity flex gap-2">
                            <button className="p-2.5 rounded-full hover:bg-brand-black hover:text-white text-gray-400 transition-all"><Edit2 size={16}/></button>
                         </div>
                       </div>
                     ))}
                   </div>
                  ...
                  <div className="relative bg-white rounded-[2rem] p-8 w-full max-w-lg shadow-2xl animate-in zoom-in-95 pointer-events-auto">
                      ...
                      <div className="mt-8 flex justify-end">
                          <button 
                            ...
                            className="px-6 py-3 bg-[#ff3600] text-white rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg"
                          >
